...
This outlines how to propose a change to greta.gam. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("greta-dev/greta.gam", fork = TRUE)`.
...
Please note that the greta.gam project is released with a [Contributor
Code of
Conduct](https://greta-dev.github.io/greta.gam/CODE_OF_CONDUCT.md). By
